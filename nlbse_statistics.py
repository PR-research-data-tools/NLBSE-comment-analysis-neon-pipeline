...
def get_statistics(dataset_path: str, stats_filename: str, remove_weighted: bool = False) -> None:
    ...
    categories = [["deprecation", "pointer", "summary", "expand", "ownership", "rational", "usage"],
                  ["classreferences", "example", "keyimplementationpoints", "collaborators", "intent", "keymessages", "responsibilities"],
    ...
    for idx, language in enumerate(languages):
        result_path = os.path.join(os.path.join(dataset_path, language), "experiment")
